...
__DEFINE__(1666947574729, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1666947574730,"./event-store":1666947574731}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1666947574730, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1666947574731, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1666947574730,"./utils":1666947574732}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1666947574732, function(require, module, exports) {
...
return __REQUIRE__(1666947574729);
})()
