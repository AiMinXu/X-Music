...
__DEFINE__(1666947574725, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1666947574726,"./event-store":1666947574727}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1666947574726, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1666947574727, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1666947574726,"./utils":1666947574728}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1666947574728, function(require, module, exports) {
...
return __REQUIRE__(1666947574725);
})()
